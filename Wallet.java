...
import org.tron.core.db.ApproveStore;
...
public class Wallet {
  ...
  public Approve getApprove(Approve approve) {
    ApproveStore approveStore = dbManager.getApproveStore();
    ApproveCapsule approveCapsule = approveStore.get(approve.getOwnerAddress().toByteArray());
    if (approveCapsule == null) {
      return null;
    }

    return approveCapsule.getInstance();
  }
}
