...
import org.tron.core.services.interfaceOnSolidity.http.GetApproveOnSolidityServlet;
...
public class HttpApiOnSolidityService implements Service {
  ...
  @Autowired
  private GetApproveOnSolidityServlet getApproveOnSolidityServlet;
  @Override
  public void init() {
  ...
  public void start() {
    try {
      ...
      context.addServlet(new ServletHolder(getApproveOnSolidityServlet), "/wallet/getapproveinfo");
