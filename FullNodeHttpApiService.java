...
public class FullNodeHttpApiService implements Service {
  ...
  @Autowired
  private ApproveServlet approveServlet;
  @Autowired
  private GetApproveServlet getApproveServlet;
  @Override
  public void init() {
  ...
  public void start() {
    try {
      ...
      context.addServlet(new ServletHolder(approveServlet), "/approve");
      context.addServlet(new ServletHolder(getApproveServlet), "/getapproveinfo");
      server.start();
    } catch (Exception e) {
