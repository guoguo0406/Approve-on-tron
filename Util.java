      ...
      try {
        ...
        switch (contract.getType()) {
          ...
          case ApproveContract:
            ApproveContract approveContract = contractParameter
                    .unpack(ApproveContract.class);
            contractJson = JSONObject
                    .parseObject(JsonFormat.printToString(approveContract));
            break;
      ...
      try {
        ...
        switch (contractType) {
          ...
          case "UpdateEnergyLimitContract":
            ...
            break;
          case "ApproveContract":
            ApproveContract.Builder approveContractBuilder = ApproveContract
                    .newBuilder();
            JsonFormat
                    .merge(parameter.getJSONObject("value").toJSONString(),
                            approveContractBuilder);
